...
const userSchema = new Schema({
  ...
  country: {
    type: String,
    enum: ['Bulgaria', 'Germany', 'United Kingdom', 'United States of America']
  },
  image: {
    type: String,
  ...
  specialization: {
    type: String,
    enum: ['Software Engineer', 'Web Designer', 'Article Writer', 'Digital Marketeer', 'Accountant']
  },
  skills: [String],
  successRate: {
    type: Number,
  ...
  role: {
    type: String,
    enum: ['contributor', 'manager', 'owner', 'visitor', 'unassigned']
  }
});
