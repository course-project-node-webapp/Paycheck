...
module.exports = function (app, data) {
  ...
  require('./organization-projects-router.js')(app, express, data.organizationsData, data.projectsData);
  require('./organization-employees-router')(app, express, data.organizationsData, data.userData);
