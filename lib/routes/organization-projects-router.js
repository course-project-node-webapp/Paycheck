...
module.exports = function ({app, express, data, controllerLoaders}) {
  ...
  organizationProjectsRouter
    ...
    .get('/:organizationId/projects/:projectId/tasks/add', (req, res) => {
      if (!organizationProjectsController) {
        organizationProjectsController = getOrganizationProjectsController({ data, organizationProjectsControllerLoader });
      }

      organizationProjectsController.addTaskForm(req, res);
    })
    .post('/:organizationId/projects/:projectId/tasks/add', (req, res) => {
      if (!organizationProjectsController) {
        organizationProjectsController = getOrganizationProjectsController({ data, organizationProjectsControllerLoader });
      }

      organizationProjectsController.addTask(req, res);
    })
    .get('/:organizationId/projects/:projectId/tasks/:taskId', (req, res) => {
      if (!organizationProjectsController) {
        organizationProjectsController = getOrganizationProjectsController({ data, organizationProjectsControllerLoader });
      }
    ...
    .get('/:organizationId/projects/:projectId/tasks', (req, res) => {
      ...
      organizationProjectsController.listTasks(req, res);
    })
    ...
    .get('/:organizationId/projects/:projectId/employees/remove/:employeeId/:role', (req, res) => {
      ...
      organizationProjectsController.removeEmployeeFromProject(req, res);
    })
...
function getOrganizationProjectsController({data, organizationProjectsControllerLoader}) {
  const {
    projectsData,
    organizationsData,
    userData
  ...
  return organizationProjectsControllerLoader(organizationsData, projectsData, userData);
}