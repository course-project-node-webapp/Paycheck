  ...
  function update(req, res) {
    ...
    userData.getUserById(userId)
      .then((user) => {
        ...
        let passwordConfirm = encryptor
          .generateHashedPassword(user.salt, updatedUser.passwordConfirm);
        ...
        if (updatedUser.password) {
          updatedUser.hashedPassword = encryptor
            .generateHashedPassword(user.salt, updatedUser.password);
        }
